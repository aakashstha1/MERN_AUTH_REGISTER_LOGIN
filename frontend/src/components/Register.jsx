...
const Register = ({ setIsRegisterOpen, setIsLoginOpen }) => {
    ...
    <dialog open className="modal fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
      <div className="modal-box w-[30%]">
        <form onSubmit={handleRegister}>
          ...
          <button type="button" className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2" onClick={() => setIsRegisterOpen(false)}>
            ✕
          </button>
          <div className="mt-2">
